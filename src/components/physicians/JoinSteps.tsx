...
import { Search, FileText, Users, TrendingUp, ArrowRight } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-2xl mx-auto">
              A streamlined process to become a member.
            </p>
          </div>
          ...
          >
            <Button
              asChild
              size="lg"
              className="bg-brand-teal hover:bg-brand-teal/90 text-white shadow-lg hover:shadow-xl transition-all duration-300"
            >
              <Link href="/join-us">
                Join Now
