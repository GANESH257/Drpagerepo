...
export function NewHomeHeroDocumented() {
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16 min-h-[600px] md:min-h-[700px] py-12 md:py-16 lg:py-20">
          ...
          <div className="flex-1 w-full lg:w-auto">
            ...
            >
              ...
              {/* Stats Strip - Always in one line */}
              <div
                className="inline-flex flex-nowrap items-center justify-start gap-0 mb-8 md:mb-10 bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl border border-white/20 shadow-xl overflow-hidden w-fit"
                style={{
                  opacity: isVisible ? 1 : 0,
          ...
          <div className="flex-shrink-0 w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 xl:w-[500px] xl:h-[500px] rounded-full overflow-hidden relative">
              ...
              >
                <source src="/Backgroundnew2.mp4" type="video/mp4" />
              </video>
          </div>
        </div>
      </div>
