...
export function FloatingCTA() {
  ...
  return (
    <div
      className="fixed bottom-4 right-4 z-[100] md:bottom-8 md:right-8 pointer-events-auto flex flex-col gap-2 items-end"
      style={{
        opacity: 1,
    ...
    >
      ...
      {/* Find a Practice - Just above Join */}
      <Link
        href="/practices"
