...
export function FAQSection() {
  ...
  return (
    <section ref={sectionRef} id="faq" className="py-6 md:py-8 relative overflow-hidden skin-paper">
      {/* NOTE: 3D animated question-mark shapes background commented out. To restore: uncomment the block below.
          CSS for .faq-3d-bg and .faq-3d-q lives in globals.css (search "faq-3d-bg"); shapes/opacity/speed can be adjusted there. */}
