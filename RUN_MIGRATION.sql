-- ============================================
-- SQL Migration: Approval Requests Schema
...
-- ============================================
-- Ensure practice_services table exists
-- ============================================
...
-- ============================================
-- Ensure practice_insurance table exists
-- ============================================
...
-- ============================================
-- Ensure practice_roles table exists
-- ============================================
...
-- ============================================
-- Add missing columns to approval_requests (if table already exists)
-- ============================================
DO $$ 
BEGIN
...
-- ============================================
-- Add missing columns to approval_history (if table already exists)
-- ============================================
DO $$ 
BEGIN
...
-- Check approval_history columns
SELECT column_name, data_type FROM information_schema.columns 
...
WHERE tablename IN ('approval_requests', 'approval_history', 'practice_roles')
